module github.com/switchlyprotocol/midgard
...
require (
	...
	gitlab.com/thorchain/thornode/v3 v3.5.0-rc1
...
replace (
	...
	github.com/binance-chain/tss-lib => github.com/switchlyprotocol/tss/tss-lib v0.1.5
