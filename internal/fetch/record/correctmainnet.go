...
func loadMainnetMissingWithdraws() {
	...
	addWithdraw(63519, AdditionalWithdraw{
		...
		Reason:   "bug 1643 corrections fix for asymmetric rune withdraw problem",
		RuneE8:   1999997,
		AssetE8:  0,
		Units:    1029728,
	})
	...
	addWithdraw(7732800, AdditionalWithdraw{
		Pool:     "AVAX.USDT-0X9702230A8EA53601F5CD2DC00FDBC13D4DF4A8C7",
		FromAddr: "thor178wlyhtpvth7f7zmrusfcqurvysxv9jngalunk",
		Reason:   "midgard correction suspended pool withdraws missing",
		RuneE8:   0,
		AssetE8:  0,
		Units:    26915692974,
	...
	addWithdraw(7732800, AdditionalWithdraw{
		Pool:     "AVAX.USDT-0X9702230A8EA53601F5CD2DC00FDBC13D4DF4A8C7",
		FromAddr: "thor1wztmenpsv5wn80ev6zzsmu5647gdrc0srgdfsz",
		Reason:   "midgard correction suspended pool withdraws missing",
		RuneE8:   0,
		AssetE8:  0,
		Units:    21246444516,
	})
	addWithdraw(5356800, AdditionalWithdraw{
		Pool:     "ETH.GUSD-0X056FD409E1D7A124BD7017459DFEA2F387B6D5CD",
		FromAddr: "thor1ws0sltg9ayyxp2777xykkqakwv2hll5ywuwkzl",
		Reason:   "midgard correction suspended pool withdraws missing",
		RuneE8:   0,
		AssetE8:  0,
		Units:    491759129,
...
var mainnetArtificialDepthChanges = artificialPoolBallanceChanges{
	...
	// Not sure why this happened but the pool was missing asset
	12896803: {
		{"BSC.BNB", 0, 1},
	},
	13610280: {
...
func loadMainnetTHORNodeInvariats() {
	...
	mintSynths := []Coinbase{
		{
			Asset:    []byte("ETH/USDT-0XDAC17F958D2EE523A2206206994597C13D831EC7"),
			AssetE8:  173198253248,
			Receiver: []byte("thor1v8ppstuf6e3x0r4glqc68d5jqcs2tf38cg2q6y"),
		},
	}
