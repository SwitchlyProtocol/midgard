...
func TestUSDHistoryE2E(t *testing.T) {
	...
	require.Equal(t, "3", jsonResult.Intervals[2].AssetPriceUSD)
	require.Equal(t, "3", jsonResult.Intervals[3].AssetPriceUSD)
	require.Equal(t, "15", jsonResult.Intervals[4].AssetPriceUSD)
}
